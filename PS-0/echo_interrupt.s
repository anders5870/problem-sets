...
main:
	...
	### TODO: Load the value of RECEIVER_CONTROL to $t0.
...
__save_registers:
	...
	move $k0, $v0		# Copy value of $at to $k0.
	sw $k0, __v0		# Save value of $at to memory.
	move $k0, $a0		# Copy value of $at to $k0.
	sw $k0, __a0		# Save value of $at to memory.
       	move $k0, $a1		# Copy value of $at to $k0.
	sw $k0, __a1		# Save value of $at to memory.
	move $k0, $t0		# Copy value of $at to $k0.
	sw $k0, __t0		# Save value of $at to memory.
